...
**2. Permissions**
The extension requires minimal permissions to provide its core functionality:
* `storage`: Used solely to save and load user preferences (such as zoom steps, rotation angles, keyboard shortcuts, and excluded domain lists) locally on your device.
* `contextMenus`: Used to display shortcut controls in the browser's right-click context menu.
* Host Permissions: Solely required to inject the content script and styles so users can interact with, zoom, rotate, and drag images or background graphics across any webpage they visit. The extension does not monitor, read, collect, or transmit any webpage content, DOM text, form inputs, or browsing history.

**3. Remote Code & Third-Party Services**
The extension does not use remote code, external scripts (e.g., CDNs), or third-party analytics services. All assets and logic run entirely offline within the extension package.

**4. External Links & Support (Ko-fi)**
